...
- 🛣️ Traceroute salto a salto anotado con el **AS de origen** de cada IP intermedia.
- 🏷️ Resolución automática del **nombre/descripción del AS** vía Team Cymru whois.
...
- ⚙️ Instalación en un solo paso como comandos globales del sistema.
...
## 🛠️ Opciones del comando traceroute en Linux
